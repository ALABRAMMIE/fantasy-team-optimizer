...
# --- Page Config ---
st.set_page_config(page_title="Fantasy Team Optimizer v3.8 (Fix NameError)", layout="wide")
st.title("Fantasy Team Optimizer v3.8 (Fix NameError)")
st.markdown("""
**Update v3.8:**
* **Bugfix:** De `NameError` opgelost door variabele-namen uniek te maken (`solver_status_text` vs `prob.status`).
* **Stabiliteit:** De 'Closest Match' functie is robuuster gemaakt tegen crashes bij krappe budgetten.
""")
...
if st.button("🚀 Optimize Teams"):
    ...
    # Let op: ik gebruik nu 'solver_status_text' om conflicten met 'prob.status' te voorkomen
